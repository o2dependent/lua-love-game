AttackItemEffect = GameObject:extend()

function AttackItemEffect:new(area, x, y, opts)
	AttackItemEffect.super.new(self, area, x, y, opts)
...
function AttackItemEffect:draw()
